...
-- Acelga
('p-20101', 'acelga-fresca', 'Acelga', 'Hojas verdes y tallos tiernos', 'hojas', 'verduras', 3500, 2400, NULL, 'kg', 'Finca Marinilla · Antioquia', 4.5, 42, 'nuevo', 25, 10, 
...
-- Apio
('p-20102', 'apio-ensalada', 'Apio de Ensalada', 'Crocante y refrescante para jugos o ensaladas', 'hojas', 'verduras', 4200, 3100, 4800, 'kg', 'Finca Marinilla · Antioquia', 4.7, 85, NULL, 15, 5, 
...
-- Lechuga Batavia
('p-20111', 'lechuga-batavia', 'Lechuga Batavia', 'La base perfecta para tus ensaladas diarias', 'hojas', 'verduras', 2800, 1900, NULL, 'unidad', 'Finca Marinilla · Antioquia', 4.9, 156, 'bestseller', 50, 20, 
...
-- Repollo Morado
('p-20121', 'repollo-morado', 'Repollo Morado', 'Color vibrante y textura crujiente', 'hojas', 'verduras', 5200, 3800, 5900, 'kg', 'Finca Marinilla · Antioquia', 4.6, 28, 'temporada', 12, 8, 
